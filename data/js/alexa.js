function getField(fieldName, buttonName) {
  ...
  setTimeout(() => {
    ...
    xhttp.onreadystatechange = function () {
      alert("passei aqui 1", this.responseText);
...
function saveField(fieldName, buttonName) {
  ...
  setTimeout(() => {
    ...
    // String urlParams = "/dispositivo?";
    // urlParams.concat(fieldName);
    // urlParams.concat('=');
    // String fieldValue = document.getElementById(fieldName).value;
    // urlParams.concat(fieldValue);
